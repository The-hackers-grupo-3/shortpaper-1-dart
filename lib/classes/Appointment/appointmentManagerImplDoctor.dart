...
import '../../interfaces/IAppointmentManagerDoctor.dart';
...
class AppointmentManagerImplDoctor implements IAppointmentManagerDoctor{
  ...
  void acceptAppointment(Appointment appointment) {
    ...
    print('El Doctor ${appointment.doctor.name} acepto la cita solicitada por el paciente ${appointment.patient.name} para el dia ${appointment.appointmentDate}.');
  }
